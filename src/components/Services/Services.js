        ...
        <section id="services" className="my-5">
            ...
            {/* description content  */}
                <div className="row pt-2 pb-2 mt-0 mb-3">
                    <div className="col-12 col-md-6 col-lg-6 border-end">
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-12 col-md-6 col-lg-6  mt-4">
                        <div className="services__content">
                            <div className="text-primary fs-1 d-block  fas fa-paper-plane"></div>
                                ...
                                <span className='fw-bold m-2 py-1'>Learn More</span>
                    ...
                    <div className="col-12 col-md-6 col-lg-6 mt-4 text-end">
                ...
                <div className="row flex-column-reverse flex-lg-row">
                    <div className="col-12 col-md-6 col-lg-6 mt-4 text-start  ">
                        <div className='text-center'>
                        <img src={img2} className='img-fluid' alt="" />
                        </div>
                    </div>
                    <div className="col-12 col-md-5 col-lg-6  mt-4 ">
                        <div className="services__content">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4 text-end">
                        <div className="services__content">
